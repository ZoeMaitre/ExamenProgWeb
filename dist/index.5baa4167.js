...
var _country = require("./modules/Country");
...
countries.then((data)=>{
    data.forEach((el)=>{
        tableauCountries.push(new (0, _countryDefault.default)(el));
    });
...
},{"./modules/Country":"awnIH","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"awnIH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Country {
    ...
    checkAnswer(reponse) {
        ...
        if (this.answers.has(reponseNormalisee)) return true;
        else return false;
    }
    renderFlag() {
...
},{}]},["hbj89","igcvL"], "igcvL", "parcelRequire2013")
